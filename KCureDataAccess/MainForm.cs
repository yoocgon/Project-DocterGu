    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            try
            {
                ...
                uiServerPrti = new CUiServer(false, this, txtServerPrti, tvwServerPrti, lvwServerPrti, lvwStatus, prgSub, prgMain, btnStop, btnRequestFile);
                uiServerCarry = new CUiServer(true, this, txtServerCarry, tvwServerCarry, lvwServerCarry, lvwStatus, prgSub, prgMain, btnStop, btnRequestFile);
            }
            catch (Exception ex)
            {
        ...
        private async void btnRequestFile_Click(object sender, EventArgs e)
        {
            ...
            List<string> cryOutFiles = files
                                    .Select(f => CCommon.LoginResult
                                                    .GetUrlDirectory(
                                                        UrlDirectoryTypes.TrimBaseFolder,
